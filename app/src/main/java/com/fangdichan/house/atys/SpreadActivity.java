...
public class SpreadActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_sprad=(ListView) findViewById(R.id.lv_spread);
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            {
                case 1:
                    List<SpreadInfo> infos=(List<SpreadInfo>) msg.obj;
                    adapter=new SpreadAdapter(SpreadActivity.this,infos);
    ...
    private void get_spread()
    {
        String jsonData = new NetCore().GetSpreads(StaticValues.user_info.getId());
        if (jsonData != null)
        {
            List<SpreadInfo> infos=null;
            try
            {
                Gson gson = new Gson();
                infos = gson.fromJson(jsonData, new TypeToken<List<SpreadInfo>>(){}.getType());
            }
            catch (Exception e)
            {
                e.printStackTrace();
